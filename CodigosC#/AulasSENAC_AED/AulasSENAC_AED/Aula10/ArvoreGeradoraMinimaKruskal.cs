...
namespace AulasSENAC_AED.Aula10
{
    ...
    class ArvoreGeradoraMinimaKruskal
    {
    ...
    ArvoreGeradoraMinimaKruskal(int v, int e)
    {
        V = v;
        E = e;
        edge = new Edge[E];
    ...
    public static void main(String[] args)
    {
        ...
        ArvoreGeradoraMinimaKruskal graph = new ArvoreGeradoraMinimaKruskal(V, E);
